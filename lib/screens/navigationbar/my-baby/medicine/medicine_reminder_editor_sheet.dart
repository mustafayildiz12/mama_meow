...
class MedicineReminderEditorSheet extends StatefulWidget {
  final MedicineReminderItem? initial;
  const MedicineReminderEditorSheet({super.key, this.initial});

  @override
  State<MedicineReminderEditorSheet> createState() => _MedicineReminderEditorSheetState();
}

class _MedicineReminderEditorSheetState extends State<MedicineReminderEditorSheet> {
  late TimeOfDay _time;
  late Set<int> _days;
  late bool _enabled;

  // English labels; 1=Mon … 7=Sun
  static const days = [
    {'label': 'Mon', 'value': 1},
    {'label': 'Tue', 'value': 2},
    {'label': 'Wed', 'value': 3},
  ...
  void initState() {
    ...
    _time = it?.timeOfDay ?? const TimeOfDay(hour: 8, minute: 0); // default 08:00
      ...
      builder: (context, ctrl) {
        return Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(colors: [Colors.lightBlue.shade50, Colors.lightBlue.shade100]),
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(widget.initial == null ? 'New Medicine Reminder' : 'Edit Medicine Reminder',
                ...
                Wrap(
                  ...
                  children: days.map((d) {
                    ...
                    return FilterChip(
                      ...
                      side: BorderSide(color: sel ? Colors.lightBlue : Colors.black12),
                    );
                  }).toList(),
                ),
