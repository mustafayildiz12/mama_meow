...
class SolidReminderEditorSheet extends StatefulWidget {
  final SolidReminderItem? initial;
  const SolidReminderEditorSheet({super.key, this.initial});

  @override
  State<SolidReminderEditorSheet> createState() => _SolidReminderEditorSheetState();
}

class _SolidReminderEditorSheetState extends State<SolidReminderEditorSheet> {
            ...
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: Text(widget.initial == null ? 'New Solid Reminder' : 'Edit Solid Reminder',
                ...
                Wrap(
                  ...
                  children: days.map((d) {
                    ...
                    return FilterChip(
                      ...
                      side: BorderSide(color: sel ? Colors.teal : Colors.black12),
                    );
                  }).toList(),
                ),
