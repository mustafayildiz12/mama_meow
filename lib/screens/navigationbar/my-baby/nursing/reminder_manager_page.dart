...
class NursingRemindersManagerPage extends StatefulWidget {
  ...
  @override
  State<NursingRemindersManagerPage> createState() =>
      _NursingRemindersManagerPageState();
}

class _NursingRemindersManagerPageState
    extends State<NursingRemindersManagerPage> {
  List<NursingReminderItem> _items = [];
  ...
  Future<void> _add() async {
    ...
    final id = await NursingRemindersStore.nextId();
    final item = NursingReminderItem(
      reminderId: id,
  ...
  Future<void> _edit(NursingReminderItem it) async {
    final result = await showModalBottomSheet<Map<String, dynamic>>(
      ...
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (_) => ReminderEditorSheet(initial: it),
    );
    if (result == null) return;
  ...
  Future<void> _delete(NursingReminderItem it) async {
...
class _ReminderCard extends StatelessWidget {
  final NursingReminderItem item;
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Row(
              children: [
                CircleAvatar(child: const Icon(Icons.access_time)),
