...
class MedicineReminderItem {
  ...
  factory MedicineReminderItem.fromJson(Map<String, dynamic> j) {
    return MedicineReminderItem(
...
class MedicineRemindersStore {
  static const _key = 'medicine_reminders_list_v1';
  static const _idKey = 'medicine_reminders_next_id_v1';

  static Future<List<MedicineReminderItem>> loadAll() async {
    final raw = localStorage.read(_key);
    if (raw == null) return [];
    return (jsonDecode(raw) as List)
        .map((e) => MedicineReminderItem.fromJson(e))
        .toList();
  }

  static Future<void> saveAll(List<MedicineReminderItem> items) async {
