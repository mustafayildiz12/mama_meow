...
class PumpingReminderItem {
  ...
  PumpingReminderItem copyWith({
    int? reminderId,
    TimeOfDay? timeOfDay,
    Set<int>? weekdays,
    bool? enabled,
  }) {
    return PumpingReminderItem(
  ...
  factory PumpingReminderItem.fromJson(Map<String, dynamic> j) {
    return PumpingReminderItem(
...
class PumpingRemindersStore {
  static const _key = 'pumping_reminders_list_v1';
